"""
DEPRECATED: Old Prism Core using project.json storage.

This module is deprecated and will be removed in a future version.
Use prism.core with .prism/ folder-based storage instead.
"""
import warnings
warnings.warn(
    "Old Core (project.json storage) is deprecated. "
    "Use prism.core with .prism/ storage instead.",
    DeprecationWarning,
    stacklevel=2
)
...
from prism.navigator_old import Navigator
