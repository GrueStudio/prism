...
from prism.managers.navigation_manager import NavigationManager, SPECIAL_TOKENS
...
class TestPathResolution:
    ...
    def test_get_item_by_path_full_path(self, sample_project):
        ...
        action = nav.get_item_by_path("phase-1/milestone-1/objective-1/deliverable-1/action-1")
...
class TestResolveSpecialToken:
    ...
    def test_resolve_up_token(self, sample_project):
        ...
        nav.project.task_cursor = "phase-1/milestone-1/objective-1/deliverable-1/action-1"
...
class TestDepthFirstValidation:
    ...
    def test_path_behind_earlier_phase(self, sample_project, mock_data):
        ...
        phase2 = mock_data.create_phase(name="Phase 2", slug="phase-2", uuid="phase-2-uuid")
        sample_project.add_child(phase2)
        
        nav.project.task_cursor = "phase-2/milestone-1/objective-1/deliverable-1/action-1"
        
        assert nav._is_path_behind("phase-1", "phase-2/milestone-1/objective-1/deliverable-1/action-1") is True
    ...
    def test_path_behind_earlier_milestone(self, sample_project, mock_data):
        ...
        milestone2 = mock_data.create_milestone(
            name="Milestone 2", slug="milestone-2",
            parent_uuid="phase-1-uuid", uuid="milestone-2-uuid"
        )
        sample_project.phases[0].add_child(milestone2)
        
        nav.project.task_cursor = "phase-1/milestone-2/objective-1/deliverable-1/action-1"
        
        assert nav._is_path_behind("phase-1/milestone-1", "phase-1/milestone-2/objective-1/deliverable-1/action-1") is True
    ...
    def test_path_not_behind_ancestor(self, sample_project):
        ...
        assert nav._is_path_behind("phase-1", "phase-1/milestone-1/objective-1/deliverable-1/action-1") is False
        assert nav._is_path_behind("phase-1/milestone-1", "phase-1/milestone-1/objective-1/deliverable-1/action-1") is False
    ...
    def test_path_not_behind_later_sibling(self, sample_project):
        ...
        assert nav._is_path_behind("phase-1/milestone-1/objective-1/deliverable-1/action-2", "phase-1/milestone-1/objective-1/deliverable-1/action-1") is False
